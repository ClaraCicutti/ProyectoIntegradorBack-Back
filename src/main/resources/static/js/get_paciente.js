            ...
            success: function(response){
              $.each(response, (i, paciente) => {
                ...
                let pacienteRow = '<tr id=\"' + tr_id + "\"" + '>' +
                          ...
                          '<td class=\"td_matricula\">' + paciente.fechaIngreso + '</td>' +
                          ...
                          '<td class=\"td_matricula\">' + paciente.domicilio.localidad + '</td>' +
                          '<td class=\"td_matricula\">' + paciente.domicilio.provincia + '</td>' +
                          '</tr>';
